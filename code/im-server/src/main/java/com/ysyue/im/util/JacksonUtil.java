...
public class JacksonUtil {
    ...
    public <T> byte[] toBytes(T object) {
        ...
        try {
            return object instanceof byte[] ? (byte[]) object : OBJECT_MAPPER.writeValueAsBytes(object);
        } catch (JsonProcessingException e) {
     ...
     * @return 目标对象
     */
    public <T> T toBean(byte[] data, Class<T> clazz) {
        ...
        try {
            ...
            log.error("Parse byte[] to Object error", e);
            return null;
        }
    }
